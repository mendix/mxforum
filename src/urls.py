...
urlpatterns = patterns('',
    ...
    url(r'^userview/(?P<openid>https(:|%3A)//mxid2.mendixcloud.com/mxid2/id(\?|%3F)id(=|%3D)[0-9a-f\-]*)//*', app.user_view, name='user_view'),
    ...
    (r'^user_import2/', 'forum.views.user_import_service2'),
    (r'^user_import2/service.wsdl', 'forum.views.user_import_service2'),
