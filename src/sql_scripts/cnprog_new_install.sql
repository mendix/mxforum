...
--
-- Create schema mxforum
--

CREATE DATABASE IF NOT EXISTS mxforum;
USE mxforum;

--
-- Definition of table `mxforum`.`answer`
--

DROP TABLE IF EXISTS `mxforum`.`answer`;
CREATE TABLE  `mxforum`.`answer` (
...
--
-- Definition of table `mxforum`.`auth_group`
--

DROP TABLE IF EXISTS `mxforum`.`auth_group`;
CREATE TABLE  `mxforum`.`auth_group` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `mxforum`.`auth_group`
--

--
-- Definition of table `mxforum`.`auth_group_permissions`
--

DROP TABLE IF EXISTS `mxforum`.`auth_group_permissions`;
CREATE TABLE  `mxforum`.`auth_group_permissions` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `mxforum`.`auth_group_permissions`
--

--
-- Definition of table `mxforum`.`auth_message`
--

DROP TABLE IF EXISTS `mxforum`.`auth_message`;
CREATE TABLE  `mxforum`.`auth_message` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `mxforum`.`auth_message`
--

--
-- Definition of table `mxforum`.`auth_permission`
--

DROP TABLE IF EXISTS `mxforum`.`auth_permission`;
CREATE TABLE  `mxforum`.`auth_permission` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `mxforum`.`auth_permission`
--
INSERT INTO `mxforum`.`auth_permission` VALUES  (1,'Can add permission',1,'add_permission'),
...
--
-- Definition of table `mxforum`.`auth_user`
--

DROP TABLE IF EXISTS `mxforum`.`auth_user`;
CREATE TABLE  `mxforum`.`auth_user` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `mxforum`.`auth_user`
--
INSERT INTO `mxforum`.`auth_user` VALUES  (2,'chagel','','','chagel@gmail.com','sha1$6a2fb$0d2ffe90bcba542fc962f57967a88e507799cc74',1,1,1,'2008-12-16 15:35:17','2008-12-11 20:12:53',0,0,0,1,'8c1efc4f4618aa68b18c88f2bcaa5564',10,NULL,NULL,NULL,NULL,NULL,NULL),
...
--
-- Definition of table `mxforum`.`auth_user_groups`
--

DROP TABLE IF EXISTS `mxforum`.`auth_user_groups`;
CREATE TABLE  `mxforum`.`auth_user_groups` (
  `id` int(11) NOT NULL auto_increment,
  `user_id` int(11) NOT NULL,
  `group_id` int(11) NOT NULL,
  PRIMARY KEY  (`id`),
...
--
-- Dumping data for table `mxforum`.`auth_user_groups`
--

--
-- Definition of table `mxforum`.`auth_user_user_permissions`
--

DROP TABLE IF EXISTS `mxforum`.`auth_user_user_permissions`;
CREATE TABLE  `mxforum`.`auth_user_user_permissions` (
  `id` int(11) NOT NULL auto_increment,
  `user_id` int(11) NOT NULL,
  `permission_id` int(11) NOT NULL,
  PRIMARY KEY  (`id`),
...
--
-- Dumping data for table `mxforum`.`auth_user_user_permissions`
--

--
-- Definition of table `mxforum`.`award`
--

DROP TABLE IF EXISTS `mxforum`.`award`;
CREATE TABLE  `mxforum`.`award` (
  `id` int(11) NOT NULL auto_increment,
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `mxforum`.`award`
--

--
-- Definition of table `mxforum`.`badge`
--

DROP TABLE IF EXISTS `mxforum`.`badge`;
CREATE TABLE  `mxforum`.`badge` (
  `id` int(11) NOT NULL auto_increment,
  `name` varchar(50) NOT NULL,
...
--
-- Dumping data for table `mxforum`.`badge`
--

--
-- Definition of table `mxforum`.`comment`
--

DROP TABLE IF EXISTS `mxforum`.`comment`;
CREATE TABLE  `mxforum`.`comment` (
  `id` int(11) NOT NULL auto_increment,
  `content_type_id` int(11) NOT NULL,
...
--
-- Dumping data for table `mxforum`.`comment`
--

--
-- Definition of table `mxforum`.`django_admin_log`
--

DROP TABLE IF EXISTS `mxforum`.`django_admin_log`;
CREATE TABLE  `mxforum`.`django_admin_log` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `mxforum`.`django_admin_log`
--
INSERT INTO `mxforum`.`django_admin_log` VALUES  (1,'2008-12-18 23:41:41',2,7,'1','mxforum.com',2,'已修改 domain 和 name 。');

--
-- Definition of table `mxforum`.`django_authopenid_association`
--

DROP TABLE IF EXISTS `mxforum`.`django_authopenid_association`;
CREATE TABLE  `mxforum`.`django_authopenid_association` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `mxforum`.`django_authopenid_association`
--
INSERT INTO `mxforum`.`django_authopenid_association` VALUES  (2,'https://www.google.com/accounts/o8/ud','AOQobUfcCH4sgjsBGGscrzxIa5UM4clofAB6nixx8Qq_NWco4ynn_Kc4','u5cva43abzdwF8CJOFZfkzfk7x8=\n',1229022261,1229022261,'HMAC-SHA1'),
...
--
-- Definition of table `mxforum`.`django_authopenid_nonce`
--

DROP TABLE IF EXISTS `mxforum`.`django_authopenid_nonce`;
CREATE TABLE  `mxforum`.`django_authopenid_nonce` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Definition of table `mxforum`.`django_authopenid_userassociation`
--

DROP TABLE IF EXISTS `mxforum`.`django_authopenid_userassociation`;
CREATE TABLE  `mxforum`.`django_authopenid_userassociation` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `mxforum`.`django_authopenid_userassociation`
--
INSERT INTO `mxforum`.`django_authopenid_userassociation` VALUES  (2,'https://www.google.com/accounts/o8/id?id=AItOawl7CVVHl4DWtteqj4dd_A23zKRwPZgOOjw',2),
 (3,'https://me.yahoo.com/a/f8f2zXF91okYL4iN2Zh4P542a5s-#f4af2',3),
 (4,'https://me.yahoo.com/sailingcai#6fa4e',4);

--
-- Definition of table `mxforum`.`django_authopenid_userpasswordqueue`
--

DROP TABLE IF EXISTS `mxforum`.`django_authopenid_userpasswordqueue`;
CREATE TABLE  `mxforum`.`django_authopenid_userpasswordqueue` (
  `id` int(11) NOT NULL auto_increment,
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `mxforum`.`django_authopenid_userpasswordqueue`
--

--
-- Definition of table `mxforum`.`django_content_type`
--

DROP TABLE IF EXISTS `mxforum`.`django_content_type`;
CREATE TABLE  `mxforum`.`django_content_type` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `mxforum`.`django_content_type`
--
INSERT INTO `mxforum`.`django_content_type` VALUES  (1,'permission','auth','permission'),
 (2,'group','auth','group'),
 (3,'user','auth','user'),
...
--
-- Definition of table `mxforum`.`django_session`
--

DROP TABLE IF EXISTS `mxforum`.`django_session`;
CREATE TABLE  `mxforum`.`django_session` (
...
--
-- Definition of table `mxforum`.`django_site`
--

DROP TABLE IF EXISTS `mxforum`.`django_site`;
CREATE TABLE  `mxforum`.`django_site` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `mxforum`.`django_site`
--
INSERT INTO `mxforum`.`django_site` VALUES  (1,'mxforum.com','mxforum.com');

--
-- Definition of table `mxforum`.`favorite_question`
--

DROP TABLE IF EXISTS `mxforum`.`favorite_question`;
CREATE TABLE  `mxforum`.`favorite_question` (
  `id` int(11) NOT NULL auto_increment,
  `question_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `added_at` datetime NOT NULL,
...
--
-- Dumping data for table `mxforum`.`favorite_question`
--

--
-- Definition of table `mxforum`.`flagged_item`
--

DROP TABLE IF EXISTS `mxforum`.`flagged_item`;
CREATE TABLE  `mxforum`.`flagged_item` (
  `id` int(11) NOT NULL auto_increment,
  `content_type_id` int(11) NOT NULL,
  `object_id` int(10) unsigned NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `mxforum`.`flagged_item`
--

--
-- Definition of table `mxforum`.`question`
--

DROP TABLE IF EXISTS `mxforum`.`question`;
CREATE TABLE  `mxforum`.`question` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Definition of table `mxforum`.`question_tags`
--

DROP TABLE IF EXISTS `mxforum`.`question_tags`;
CREATE TABLE  `mxforum`.`question_tags` (
  `id` int(11) NOT NULL auto_increment,
  `question_id` int(11) NOT NULL,
...
--
-- Definition of table `mxforum`.`tag`
--

DROP TABLE IF EXISTS `mxforum`.`tag`;
CREATE TABLE  `mxforum`.`tag` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Definition of table `mxforum`.`user_badge`
--

DROP TABLE IF EXISTS `mxforum`.`user_badge`;
CREATE TABLE  `mxforum`.`user_badge` (
...
--
-- Definition of table `mxforum`.`user_favorite_questions`
--

DROP TABLE IF EXISTS `mxforum`.`user_favorite_questions`;
CREATE TABLE  `mxforum`.`user_favorite_questions` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `user_id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `mxforum`.`user_favorite_questions`
--

DROP TABLE IF EXISTS `mxforum`.`vote`;
CREATE TABLE  `mxforum`.`vote` (
  `id` int(11) NOT NULL auto_increment,
  `content_type_id` int(11) NOT NULL,
  `object_id` int(10) unsigned NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `mxforum`.`vote`
--
